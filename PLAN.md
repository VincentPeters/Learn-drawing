...
- **Paper:** A3, smooth, 90–120 gsm (a grid/dot pad helps early on)
- **Pencils:** 2H (construction), HB and 2B (outlines and tone)
- **Accents:** optional blue + a warm pencil to highlight features
...
- **End of Phase 1:** a straight 20 cm line and a clean ellipse without correction strokes.
- **End of Phase 2:** a correct three-view drawing of a moderately complex part, checked by projection.
- **End of Phase 3:** any part drawn convincingly in isometric, including holes and cylinders.
- **End of Phase 4:** a fully dimensioned, sectioned, toleranced part drawing.
- **End of Phase 5:** a complete, title-blocked engineering drawing another person could build from — unaided.

## Resources

**Free**

- Drawabox.com — Lessons 1 & 2 (line and box control) map onto Phase 1–2.
- YouTube: *ModernDayJames* (perspective), *The Engineering Mindset* and technical-drawing channels for projection and sections.

**Books**

- *Technical Drawing* — Giesecke et al. (the standard engineering-graphics text)
